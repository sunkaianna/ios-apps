...
@property (strong, nonatomic) CMMotionManager *gManager;
@property (nonatomic) BOOL firstTime;
@property (nonatomic) BOOL timeZeroGyro;
@property (nonatomic) BOOL initializeGyroTracking;
@property (nonatomic) BOOL initializeTracking_DM;
@property (nonatomic) BOOL startDMTracking;
@property (nonatomic) BOOL startGyroTracking;
@property (nonatomic) BOOL smallAngleTracking;
@property (nonatomic) BOOL trackOrTraceFlag;
...
@property (nonatomic) NSTimeInterval time_prev_gyro;
@property (nonatomic) GLKMatrix3 rotationMatrix;
@property (nonatomic) NSMutableArray* listOfCircles;
@property(readonly, nonatomic) CMAttitude* initialRotationMatrix;
...
@property (weak, nonatomic) IBOutlet UISwitch *smallAngle;
@property (weak, nonatomic) IBOutlet UISwitch *trackOrTrace;
